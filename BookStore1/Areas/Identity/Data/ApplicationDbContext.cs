...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new ApplicationUserEntitiConfiguration());
    }


}

public class ApplicationUserEntitiConfiguration : IEntityTypeConfiguration<ApplicationUser>
{
